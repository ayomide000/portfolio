...
const style = {
    ...
    homeButton : `border-2 text-gray-200 px-4 py-2 mt-2 rounded-md text-md font-bold hover:bg-[#64ffda] hover:text-gray-900 transition duration-300 ease-in-out flex items-center` 
}
...
const Home = () => {
  return (
    ...
    <div className={style.homeCont}>
        ...
        <div>
            <button className={style.homeButton}>View Work <HiArrowNarrowRight/></button>
        </div>
    </div>
