...
const style = {
  ...
  welcome: `text-center font-bold sxs:text-[1.5rem]  text-3xl bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text`,
  wave: `animate-wave text-3xl text-blue-500`,
  homeContH1: `text-2xl sxs:text-[1rem] sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-300`,
  homeContH2: `text-2xl sxs:text-[1rem]  sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-500`,
  homeButtonCont: `flex justify-center`,
  homeButton: `border-2 group text-gray-200 px-4 py-2 mt-2 rounded-md text-md font-bold hover:border-0 hover:bg-[#64ffda] hover:text-gray-900 transition duration-300 ease-in-out flex items-center ml-4 xs:text-xs xxs:text-[8px] xxs:py-1 xxs:mt-2.5`,
  homeButtonCV: `lg:hidden border-2 group text-gray-200 px-4 py-2 mt-2 rounded-md text-md font-bold hover:border-0 hover:bg-[#64ffda] hover:text-gray-900 transition duration-300 ease-in-out flex items-center ml-4 xxs:text-[8px]`,
  arrow: `group-hover:rotate-90 duration-300`,
  imgDivCont: `w-full h-full mt-4 xs:mt-10 md:mt-0`,
